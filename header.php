...
<head>
	...
	<script src="assets/js/context_detection.js"></script>
	...
	<script src="/context/context_detection.js"></script>
	<script>
    ...
    function updateImageQuality() {
        ...
        .then(data => {
            document.querySelectorAll('img').forEach(img => {
                ...
                let newSrc = currentSrc.replace(/(low|medium|high)/, data.quality);
                img.setAttribute('src', newSrc);
            });
        }).catch(error => console.error("Error updating image quality:", error));
    }
...
<li><a href="cart.php"><i class="fa fa-shopping-cart"></i> <?php echo LANG_VALUE_18; ?> (<?php echo 'Rs. '; ?>
    <?php
        if(isset($_SESSION['cart_p_id'])) {
            ...
            echo number_format($table_total_price, 2); // Formatting price to 2 decimal places
        } else {
            echo '0.00';
        }
    ?>)
