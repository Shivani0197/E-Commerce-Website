<?php
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['contextData'])) {
    $contextData = json_decode($_POST['contextData'], true);
    $logFile = __DIR__ . '/user_context_log.txt';
    file_put_contents($logFile, date('Y-m-d H:i:s') . ' - ' . json_encode($contextData) . PHP_EOL, FILE_APPEND);
...
if (!empty($recent_searches)) {
    ...
    echo "<h2>Products based on your recent searches:</h2>";
